...
import Userkey from "../../../public/icons/userkey";
import Link from "next/link";

const lostPassword = ({ color, inputColor }) => {
                        ...
                        <div className='lg:w-[40%] w-full lg:pb-11'>
                            <SlideUp>
                                <div className={`w-[75px] h-[75px] rounded-lg flex justify-center items-center drop-shadow-3xl bg-white mb-3 text-primary`}>
                                    <Userkey width={42} height={40} fill={"currentColor"} className={`text-primary`}/>
                                </div>
                            ...
                            <SlideUp>
                                <form >
                                    <div className='mb-7.5'>
                                        <div className="mb-4">
                                            <h4 className={`text-2xl font-bold mb-3 ${color}`}>Lost Password</h4>
                                            <p className={`${color}`}>Please enter your username or email address. You will receive a link to create a new password via email.</p>
                                        </div>
                                    ...
                                    <div className='flex justify-end w-full'>
                                        <Button variant={"outline"} className="border-white border text-white hover:text-primary-foreground hover:bg-white w-full">Creat New Password</Button>
                                    </div>

                                    <div>
                                        <p className="text-center mt-[1rem] opacity-50">
                                            <Link className={`underline ${color}`} href={'/login'}>Log In</Link>
                                        </p>
