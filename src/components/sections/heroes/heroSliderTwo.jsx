    ...
    return (
        <div className='pb-2'>
            <div className='lg:max-h-[calc(40rem+2vw)] bg-[rgba(226,231,255,0.4)] dark:bg-[#1c232a] rounded-[30px] lg:pl-[52px] lg:pr-0 pl-4 pr-4 border-2 border-[rgba(0,31,63,0.05)] overflow-y-hidden overflow-x-hidden relative'>
                <div className='grid lg:grid-cols-2 grid-cols-1 items-center relative z-10'>
                    {/* ----- left side start */}
                    ...
                    <div className='relative hidden lg:flex lg:justify-end'>
                        <Image className='object-cover' src={'/images/banner/hero-img6-1.png'} width={668} height={678} alt='hero image' />
                    </div>
                </div>
            ...
            <PartnersSlider data={partnersData.slice(0, 5)} className={"max-w-[1005px] mx-auto lg:-mt-14 -mt-6 z-[11] relative dark:bg-white"} />
        </div>
    );
}
