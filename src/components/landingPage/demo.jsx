...
const Demo = () => {
  return (
    <section id="demo" className="py-[60px] max-w-[1350px] mx-auto px-[15px]">
      <div>
        <h2 className="lg:text-[300px] md:text-[230px] sm:text-[180px] text-[140px] leading-none font-extrabold text-center md:-mb-25 -mb-16 linear-text">
          08+
        </h2>
      </div>
    ...
    <SlideUp id={id}>
      <div className="bg-[#2E4DFE0D] pt-10 pb-16 px-4 rounded-3xl relative transition-all duration-500 hover:-translate-y-3">
        ...
        <Link
          href={path}
          target="_blank"
          className="text-1xl font-extrabold text-muted-foreground text-center absolute bottom-[22px] left-1/2 -translate-x-1/2 hover:text-primary-foreground transition-all duration-500"
        >
          {demo_name}
        </Link>
      </div>
